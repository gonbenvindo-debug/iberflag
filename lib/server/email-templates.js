const DEFAULT_VARIABLES = [
    ...
    { key: 'support.email', label: 'Email de suporte', group: 'Empresa', sample: 'suporte@iberflag.pt' }
];
...
function buildOrderEmailContext({ req = null, order = null, customer = null, overrides = {} } = {}) {
    ...
    return {
        ...
        support: {
            email: String(process.env.SUPPORT_EMAIL || process.env.SMTP_REPLY_TO || process.env.SMTP_FROM_EMAIL || 'suporte@iberflag.pt')
        }
    };
}
