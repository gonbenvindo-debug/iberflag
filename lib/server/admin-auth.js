...
const DEFAULT_ADMIN_EMAIL = 'admin123@iberflag.com';
...
async function isAdminEmail(email) {
    ...
    const configuredAdminEmail = normalizeEmail(getEnvValue(['ADMIN_EMAIL', 'IBERFLAG_ADMIN_EMAIL']) || DEFAULT_ADMIN_EMAIL);
