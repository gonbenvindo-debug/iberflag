...
begin
    ...
    select jsonb_build_object(
        ...
        'stripe_checkout_url', e.stripe_checkout_url,
        'stripe_payment_intent', e.stripe_payment_intent,
        'stripe_payment_method_type', e.stripe_payment_method_type,
        'payment_confirmed_at', e.payment_confirmed_at,
        'facturalusa_status', e.facturalusa_status,
        'facturalusa_last_error', e.facturalusa_last_error,
        'facturalusa_customer_code', e.facturalusa_customer_code,
        'facturalusa_document_number', e.facturalusa_document_number,
        'facturalusa_document_url', e.facturalusa_document_url,
