...
function getCheckoutErrorMessage(error) {
    ...
    if (error?.code === 'BASE_REQUIRED') {
        return i18nText('Falta selecionar a base de fixa��o de um Fly Banner. Reabra o personalizador e confirme a base antes de pagar.');
    }

    if (error?.code === 'BASE_CONFIG_MISSING') {
        return i18nText('Um Fly Banner do carrinho n�o tem bases de fixa��o configuradas no admin. Corrija a configura��o antes de continuar.');
    }

    if (error?.code === 'BASE_UNAVAILABLE') {
        return i18nText('Um Fly Banner do carrinho n�o tem bases de fixa��o dispon�veis neste momento. Reabra o personalizador e escolha outra base.');
    }
